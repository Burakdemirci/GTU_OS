...
PROCESS_START_ADDR equ 00900h	;Start address of the processes
...
file_1:	dw './Sender.com',00H
file_2:	dw './Receiver.com',00H		
...
INIT_PROCESSES:
	...
	DAD D
	MVI A,5
	LXI B,file_1		; Sender Call
	call GTU_OS

	LXI D,PROCESS_LEN
	DAD D
	LXI B,file_2 		; Receiver Call
	call GTU_OS
